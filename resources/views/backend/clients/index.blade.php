...
@section('header_buttons')
    <div class="row">
        <div class="col-sm-12 d-flex justify-content-end mb-3">
            <a href="{{ route('backend.clients.create') }}" class="btn btn-primary me-3">
                                    ...
                                    <table class="table table-hover table-striped align-middle table-nowrap mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-end" scope="col">
                                                <p class="mb-0">FD Amount</p>
                                            </th>
                                            <th class="text-center" scope="col">
                                                <p class="mb-0">Payment Frequency</p>
                                                <p class="mb-0 text-muted">Age Group</p>
                                            </th>
                                            <th class="text-center" scope="col">
                                        ...
                                        @foreach($records as $row)
                                            <tr id="row-{{ $row->id }}">
                                                ...
                                                <td class="text-center">
                                                    <p class="mb-0">{{ ipFrequency($row->ip_frequency) }}</p>
                                                    <p class="mb-0 text-muted">{{ ageGroup($row->ip_frequency) }}</p>
                                                </td>
                                                <td class="text-center">
